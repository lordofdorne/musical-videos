...
const rawVideoBucketName = 'as29-raw-videos'
const processedVideoBucketName = 'as29-processed-videos'
 ...
 * @returns A promist that resolves when the file has been deleted
 */
